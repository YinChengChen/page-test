import { Card, CardContent, Typography, Grid, FormControl, InputLabel, MenuItem} from "@mui/material";
...
export default function CardEvents() {
  ...
  const initialVideoList:videoProps[] = [
        ...
        videoUrl: './data/movies/movie_2023075' + (parseInt(targetTime) + 1).toString().padStart(2, "0") + mm[0].toString() + '.mp4'},
        {   poster: './data/images/test_' + targetTime + mm[1].toString() + '00.png', 
        videoUrl: './data/movies/movie_2023075' + (parseInt(targetTime) + 1).toString().padStart(2, "0") + mm[1].toString() + '.mp4'},
        {   poster: './data/images/test_' + targetTime + mm[2].toString() + '00.png', 
        videoUrl: './data/movies/movie_2023075' + (parseInt(targetTime) + 1).toString().padStart(2, "0") + mm[2].toString() + '.mp4'},
        {   poster: './data/images/test_' + targetTime + mm[3].toString() + '00.png', 
        videoUrl: './data/movies/movie_2023075' + (parseInt(targetTime) + 1).toString().padStart(2, "0") + mm[3].toString() + '.mp4'},
        {   poster: './data/images/test_' + targetTime + mm[4].toString() + '00.png', 
        videoUrl: './data/movies/movie_2023075' + (parseInt(targetTime) + 1).toString().padStart(2, "0") + mm[4].toString() + '.mp4'},
        {   poster: './data/images/test_' + targetTime + mm[5].toString() + '00.png', 
        videoUrl: './data/movies/movie_2023075' + (parseInt(targetTime) + 1).toString().padStart(2, "0") + mm[5].toString() + '.mp4'},
    ];
    ...
    const handleChange = (event: SelectChangeEvent) => {
        ...
        mm.map((item) => {
            newList.push({
                ...
                videoUrl: './data/movies/movie_2023075' + nextTmp.toString().padStart(2, "0") + item.toString() + '.mp4'
            });
        })
    ...
    <Card>
      <CardContent>
        ...
        <Grid container sx={{ py: 2, justifyContent: 'center'}}>
            ...
            <Grid item xs md sx={{ display: "flex", justifyContent: "flex-end", mr: 2 }}>
