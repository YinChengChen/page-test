...
const ImageGalleryWithGif = (photoList: photoList) => {
  const [index, setIndex] = useState(-1);
  const initalphotos: photoList[] = [
    { src: "", width: 850, height: 400 },
    { src: "", width: 850, height: 400 },
    { src: "", width: 850, height: 400 },
    { src: "", width: 850, height: 400 },
  ];
  const [photos, setPhotos] = useState<photoList[]>(initalphotos);
  return (
    <>
      <PhotoAlbum
        photos={photos}
